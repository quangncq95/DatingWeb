...
<div id="container-profile">
    ...
    <div class="container-fluid ">
        <form id="profile" >
            <div class="row">
                <div class="col-sm-12">
                    <input type="text" name="id_account" hidden="true" value="<sec:authentication property="principal.id_account"></sec:authentication>">
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="radio" id="gender1" value="Male" name="gender">
